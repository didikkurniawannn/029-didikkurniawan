...
var KTApp = function() {
    ...
    return {
        init: function() {
            ...
            ! function() {
                    ...
                    if ("1" !== e.getAttribute("data-kt-initialized")) {
                        ...
                        if ("true" == e.getAttribute("data-hide-search") && (t.minimumResultsForSearch = 1 / 0), $(e).select2(t), e.hasAttribute("data-dropdown-parent") && e.hasAttribute("multiple")) {
                            ...
                            if (n && n.hasAttribute("data-kt-menu")) {
                                ...
                                i || (i = new KTMenu(n)), i && ($(e).on("select2:unselect", (function(t) { e.setAttribute("data-multiple-unselect", "1") })), i.on("kt.menu.dropdown.hide", (function(t) { if ("1" === e.getAttribute("data-multiple-unselect")) return e.removeAttribute("data-multiple-unselect"), !1 })))
                            }
                        }
                ...
                function() {
                    ...
                    (e || 0 !== e.length) && e.forEach((function(e) { "1" !== e.getAttribute("data-kt-initialized") && (o(e), KTUtil.data(e).set("tns", tns), e.setAttribute("data-kt-initialized", "1")) }))
                }(), e = !0
        },
        initTinySlider: function(e) { o(e) },
        ...
        createBootstrapPopover: function(e, t) { return i(e, t) },
        createBootstrapTooltip: function(e, t) { return n(e, t) }
    }
}();
...
var KTDialer = function(e, t) {
    ...
    if (e) {
        var i = { min: null, max: null, step: 1, currency: !1, decimals: 0, prefix: "", suffix: "" },
            ...
            d = function(e) { return e = parseFloat(e).toFixed(n.options.decimals), n.options.currency && (e = e.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")), n.options.prefix + e + n.options.suffix },
    ...
    KTDrawer = function(e, t) {
        ...
        if (null != e) {
            var i = { overlay: !0, direction: "end", baseClass: "drawer", overlayClass: "drawer-overlay" },
                r = function() { n.options = KTUtil.deepExtend({}, i, t), n.uid = KTUtil.getUniqueId("drawer"), n.element = e, n.overlayElement = null, n.name = n.element.getAttribute("data-kt-drawer-name"), n.shown = !1, n.lastWidth, n.lastHeight, n.toggleElement = null, n.element.setAttribute("data-kt-drawer", "true"), o(), u(), KTUtil.data(n.element).set("drawer", n) },
                o = function() {
                    var e = m("toggle"),
                        t = m("close");
                ...
                p = function() { var e = m("height"); return "auto" === e && (e = KTUtil.css(n.element, "height")), e };
...
}, KTDrawer.init = function() { KTDrawer.createInstances(), !1 === KTDrawerHandlersInitialized && (KTDrawer.handleResize(), KTDrawer.handleShow(), KTDrawer.handleDismiss(), KTDrawer.handleEscapeKey(), KTDrawerHandlersInitialized = !0) }, "undefined" != typeof module && void 0 !== module.exports && (module.exports = KTDrawer);
    ...
    KTMenu = function(e, t) {
        ...
        if (null != e) {
            var i = { dropdown: { hoverTimeout: 200, zindex: 107 }, accordion: { slideSpeed: 250, expand: !1 } },
                ...
                a = function(e) { e || (e = n.triggerElement), !0 !== m(e) && ("dropdown" === v(e) ? w(e) : "accordion" === v(e) && A(e), KTUtil.data(e).set("type", v(e))) },
                l = function(e) { e || (e = n.triggerElement), !1 !== m(e) && ("dropdown" === v(e) ? y(e) : "accordion" === v(e) && x(e)) },
                s = function(e) {
                    if (!1 !== f(e)) {
                        var t = g(e);
                ...
                T = function(e) { var t, n; return c(e) || e.hasAttribute("data-kt-menu-trigger") ? e : KTUtil.data(e).has("item") ? KTUtil.data(e).get("item") : (t = e.closest(".menu-item")) ? t : (n = e.closest(".menu-sub")) && !0 === KTUtil.data(n).has("item") ? KTUtil.data(n).get("item") : void 0 },
            ...
            !0 === KTUtil.data(e).has("menu") ? n = KTUtil.data(e).get("menu") : r(), n.click = function(e, t) { return function(e, t) { if ((!e.hasAttribute("href") || "#" === e.getAttribute("href")) && (t.preventDefault(), !0 !== n.disabled)) { var i = T(e); "click" === L(i, "trigger") && (!1 === L(i, "toggle") ? a(i) : o(i)) } }(e, t) }, n.link = function(e, t) { return function(e, t) {!0 !== n.disabled && !1 !== KTEventHandler.trigger(n.element, "kt.menu.link.click", e) && (KTMenu.hideDropdowns(), KTEventHandler.trigger(n.element, "kt.menu.link.clicked", e)) }(e) }, n.dismiss = function(e, t) {
                return function(e, t) {
                    var n = T(e),
                        i = k(n);
...
var KTSearch = function(e, t) {
    ...
    if (e) {
        var i = { minLength: 2, keypress: !0, enter: !0, layout: "menu", responsive: null, showOnFocus: !0 },
            ...
            a = function() { n.element.classList.add("focus"), (!0 === g("show-on-focus") || n.inputElement.value.length >= n.minLength) && f() },
            l = function() { n.element.classList.remove("focus") },
            s = function(e) { 13 == (e.charCode || e.keyCode || 0) && (e.preventDefault(), d()) },
            u = function() { g("min-length") && (n.inputElement.value.length >= n.minLength ? d() : 0 === n.inputElement.value.length && c()) },
...
var KTLayoutSearch = function() {
    var e, t, n, i, r, o, a, l, s, u, d, c, m = function(e) {
        ...
        f = function(e) { t.classList.remove("d-none"), n.classList.add("d-none"), r.classList.add("d-none") };
    return {
        init: function() {
...
var KTAppSidebar = function() {
    ...
    return {
        init: function() {
            var t;
            (document.querySelector("#kt_sidebar_theme_mode_toggle").addEventListener("change", (() => { "light" === KTThemeMode.getMode() ? KTThemeMode.setMode("dark") : KTThemeMode.setMode("light") })), null !== (e = document.querySelector("#kt_app_sidebar_menu_wrapper"))) && (e && (t = e.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(t, e) && e.scroll({ top: KTUtil.getRelativeTopPosition(t, e), behavior: "smooth" }))
        }
    }
}();
