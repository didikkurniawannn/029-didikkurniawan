...
<head>
  ...
  <title>Group/Role | <?= $app_data->app_name ?></title>
  <meta charset="utf-8">
      ...
      <div class="container-fluid">
        ...
        <div class="row page-titles">
          <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Group/Role</h4>
          </div>
          <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Group/Role</li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <div class="card-body">
                <table class="table table-striped datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <?= $utils->action_group_default; ?>
                      </td>
                      <td><?= $group_role[$i]->nama; ?></td>
                      <td><?= $group_role[$i]->alias; ?></td>
                      <td>
