...
<head>
  ...
  <title>Disposisi Masuk | <?= $app_data->app_name ?></title>
  <meta charset="utf-8">
      ...
      <div class="container-fluid">
        ...
        <div class="row page-titles">
          <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Disposisi Masuk</h4>
          </div>
                    ...
                    <form action="#" method="POST" id="form_data" class="form-horizontal needs-validation" novalidate>
                      ...
                      <div class="form-action m-t-24">
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <button type="button" class="btn btn-success w-100 mailbox-trigger-laporan"><i class="fa fa-save"></i> Submit Laporan</button>
                          </div>
                        </div>
                        <hr>
                        <div class="card shadow-none">
                          <div class="card-body">
                            <div class="table-responsive">
                              <table class="table">
                                <tbody>
                                  <tr class="mailbox-laporan-item d-none">
                                    <td>
