...
class Setting extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.utilitas.setting');
    }
    ...
    public function store()
    {
        ...
        if ($this->logo_text) {
            ...
            $model->logo_text_human_size = $this->logo_text->getSize();
        ...
        if ($this->favicon) {
            ...
            $model->favicon_human_size = $this->favicon->getSize();
        }
        ...
        if ($this->splashscreen) {
            ...
            $model->splashscreen_human_size = $this->splashscreen->getSize();
        }
