    ...
    <div class="container">
        ...
        <div class="ticket airline">
            <div class="top">
                ...
                <div class="big">
                    <p class="from">MAN</p>
                    <p class="to"><i class="fas fa-arrow-right"></i> RAPAT</p>
                </div>
                <div class="top--side">
            ...
            <div class="bottom">
                <div class="column">
                    ...
                    <div class="row row-2">
                        <p><span>Waktu</span>{{ $jam }}</p>
                        {{-- <p class="row--center"><span>Departs</span>11:00 AM</p> --}}
                        {{-- <p class="row--right"><span>Tempat</span>{{ $rapat->tempart }}</p> --}}
                    </div>
                    
                    <div class="row row-3">
                        <p><span>Nama</span>{{ $kehadiran->nama }}</p>
                        <p class="row--right"><span>No.Reg</span>{{ $kehadiran->no_registrasi }}</p>
                    </div>
                </div>
                <div class="barcode">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?data={{ route('invoice',[Crypt::encrypt($kehadiran->no_registrasi)]) }}&size=100x100" alt="QR Code">
                </div>
            </div>

            <div class="info">
                <p>lihat detail <a href="{{ route('invoice',[Crypt::encrypt($kehadiran->no_registrasi)]) }}" target="_blank">klik disini</a></p>
            </div>
        </div>
...
.top .big .from {
  color: #ffcc05;
  text-shadow: -1px 0 #000, 0 3px #000, 3px 0 #000, 0 -1px #000;
}
.top .big .to {
  position: absolute;
  left: 32px;
