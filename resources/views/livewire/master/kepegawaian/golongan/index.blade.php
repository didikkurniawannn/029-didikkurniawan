            ...
            <div class="col-lg-4">
                <div class="card card-custom card gutter-b">
                    ...
                    <div class="card-header border-0">
                        <h3 class="card-title font-weight-bolder text-dark">Form Golongan</h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
                    <form action="">
                        <div class="card-body pt-0">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  @error('golongan') is-invalid @enderror" placeholder="Ex:Foo" wire:model="golongan" />
                                <input type="hidden" class="form-control  @error('golongan_id') is-invalid @enderror" wire:model="golongan_id" />
                                @error('golongan')
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder text-dark">Daftar Golongan</span>
                            ...
                            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                                <thead>
                                    <tr class="text-uppercase">
                                        ...
                                        <th style="min-width: 120px text-center">Golongan</th>
                                ...
                                <tbody>
                                    @foreach ($model as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->golongan}}</span>
                                            </td>
