...
@stop
@section('menu')
Referensi > Wilayah > <b>Provinsi</b>
@stop
<!--begin::Col-->
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        <i class="ki-outline ki-magnifier fs-3 position-absolute ms-4"></i> <input type="text"
                            ...
                            class="form-control form-control-solid w-250px ps-12" placeholder="Cari Nama Provinsi">
                    </div>
                    <!--end::Search-->
                </div>
                <!--end::Card title-->
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                        ...
                        <thead>
                            <tr class="text-uppercase">
                                <th class="pl-0" style="min-width: 100px">Kode Provinsi
                                </th>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-3 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" class="form-control  @error('name') is-invalid @enderror"
                                placeholder="Ex: Jawa Barat" wire:model="name" />
                            <input type="hidden" class="form-control  @error('id_prov') is-invalid @enderror" wire:model="id_prov" />
                            @error('name')
                            <div
