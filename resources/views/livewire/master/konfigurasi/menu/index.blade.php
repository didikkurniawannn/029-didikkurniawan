                ...
                <div class="card card-stretch mb-5 mb-xxl-8">
                    <div class="card-header align-items-center border-0 mt-5">
                        ...
                        <div class="card-toolbar">
                            <button wire:click="toggle" class="btn btn-sm btn-icon btn-color-warning btn-active-light-warning">
                    ...
                    <div class="card-body pt-0">
                        <form action="">
                            ...
                            <div class="mb-3 fv-row fv-plugins-icon-container">
                                <label>Jenis Menu
                                    <span class="text-danger">*</span></label>
                                <input type="text" class="form-control  @error('jenis_menu') is-invalid @enderror mt-1"
                                     placeholder="Ex: Backend, Front" wire:model="jenis_menu" />
                                @error('jenis_menu')
                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"> {{ $message }} </div>
                                @enderror
                            </div>
