                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    <div class="w-200 mw-350px" wire:ignore>
                        <select x-init="$($el).select2({ placeholder: '-- Pilih --', });
                                ...
                                })" wire:model.live="searchJenisInstansi" name="searchJenisInstansi"
                            id="searchJenisInstansi" class="form-control form-control-lg form-select-solid">
                            <option value="0">-- Semua --</option>
                            <option value="1">Instansi</option>
                            <option value="2">Luar Instansi</option>
                    ...
                    <table class="table table-head-custom table-vertical-center table-hover table-striped"
                        ...
                        <thead>
                            <tr class="text-uppercase">
                                ...
                                <th style="min-width: 120px text-center">No Telp </th>
                                <th style="min-width: 120px text-center">Tipe </th>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" wire:click="deleteRequest({{ $item->id }})" class="menu-link px-3">
                                                Delete
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
                                ...
                                <td>
                                    <span
                                        class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->no_telp}}</span>
                                </td>
                                <td>
                                    <span
                                        class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->type == 1 ? 'Instansi' : 'Luar Instansi' }}</span>
                                </td>
                                <td class="pr-0 text-right">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch"
                                            id="flexSwitchCheckStatus{{ $item->id }}" wire:click="status({{ $item->id }})"
    ...
    <div class="col-lg-4 col-xxl-4">
        <div class="card card-flush h-md-100">
            <div class="card-header border-0">
                <h2 class="card-title font-weight-bolder">@yield('title')
                    <div wire:dirty class="text text-secondary">
                        Draft
                    </div>
            ...
            <form action="">
                <div class="card-body">
                    ...
                    <div class="mb-3 fv-row fv-plugins-icon-container">
                        <label>Kepala
                            <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-solid @error('leader') is-invalid @enderror"
                    ...
                    <div class="mb-3 fv-row fv-plugins-icon-container">
                        <label>Website
                            <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-solid @error('website') is-invalid @enderror"
                            placeholder="Ex: https://website.com" wire:model="website" />
                        @error('website')
                        <div class="invalid-feedback form-text text-danger"> {{ $message }} </div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 fv-row fv-plugins-icon-container">
                        <label>No Telp
                            <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-solid @error('no_telp') is-invalid @enderror"
                            placeholder="Ex: 082112345678" wire:model="no_telp" />
                        @error('no_telp')
                        <div class="invalid-feedback form-text text-danger"> {{ $message }} </div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 fv-row fv-plugins-icon-container" wire:ignore>
                        ...
                        <select x-init="$($el).select2({
                                        ...
                                        $($el).on('change', function() {
                                            $wire.set('type', $($el).val())
                                        })" wire:model.live="type" name="type" id="type"
                ...
                <div class="card-footer pt-0">
                    <button type="button" wire:offline.attr="disabled" wire:loading.class.remove="btn-primary"
                        ...
                        <span wire:loading @if ($mode=='create' ) wire:target="store" @else wire:target="update" @endif
