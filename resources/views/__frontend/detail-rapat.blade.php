                ...
                <div class="card card-flush mb-xxl-10">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-900">Rapat Evaluasi Penilaian SPBE TA 2024</span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <!--begin::Tap pane-->
                            <x-detail.informasi></x-detail.informasi>
                            <!--end::Tap pane-->
                            <!--begin::Tap pane-->
                            <x-detail.waktu></x-detail.waktu>
                            <!--end::Tap pane-->
                            <!--begin::Tap pane-->
                            <x-detail.daftar-peserta></x-detail.daftar-peserta>
                            <!--end::Tap pane-->
                            <!--begin::Tap pane-->
                            <x-detail.download></x-detail.download>
                            <!--end::Tap pane-->
                        </div>
                        <!--end::Tab Content-->
                    </div>
