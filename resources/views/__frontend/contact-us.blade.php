                        ...
                        <div class="card-body p-lg-17">
                                ...
                                <div class="col-sm-6 ps-lg-10">
                                    ...
                                    <div
                                        ...
                                        <div class="text-gray-700 fs-3 fw-semibold">
                                            Komplek Pemkab. Bandung, Jalan Raya Soreang KM 17, Bandung, Jawa Barat, 40912
                                        </div>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Address-->
                            ...
                            <div class="card mb-4 bg-light text-center ">
                                ...
                                <div class="card-body py-12">
                                    <!--begin::Icon-->
                                    <a target="_blank" href="https://www.facebook.com/didikkurniawannn" class="mx-4">
                                    ...
                                    <!--begin::Icon-->
                                    <a target="_blank" href="https://www.instagram.com/kurniawan_didik/" class="mx-4">
                                    ...
                                    <!--begin::Icon-->
                                    <a target="_blank" href="https://github.com/didikkurniawannn" class="mx-4">
                                    ...
                                    <!--begin::Icon-->
                                    <a target="_blank" href="https://www.youtube.com/didikmakaryo" class="mx-4">
