                ...
                <form wire:submit.prevent="sendPasswordResetLink">
                    ...
                    <div class="text-center mb-11">
                        ...
                        <a href="javascript:void(0)" class="text-center d-block m-b-10">
                            <img src="{{ Storage::disk('public')->url('logo/green_logo.png') }}"
                                class="max-h-75px" height="75px" alt="{{ $data['title'] }}" />
                        </a>
                    ...
                    <div class="fv-row mb-8">
                        <!--begin::Email-->
                        <input placeholder="Email Aktif"
                            class="form-control  bg-transparent @error('email') is-invalid @enderror" type="text"
